...
**[This introduction is for package version: 1.3.4]**
...
*Note*: here and in the following, when referring to "mutations", we intend single
...
Finally, the manual installation of **decompTumor2Sig** can, for example, be done
